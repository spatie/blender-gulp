...
gulp.task('help', function () {
    ...
    gutil.log(gutil.colors.yellow('-------------------------------------------------------------------------------'))
    gutil.log(gutil.colors.red(   'gulp lint'), '                run lint tests')
    gutil.log(gutil.colors.red(   'gulp favicon'), '             standalone utility for favicon generation')
    gutil.log(gutil.colors.red(   'gulp og-image'), '            generate screenshot og-image from GULP_BROWSERSYNC_PROXY in .env')
    gutil.log(gutil.colors.yellow('-------------------------------------------------------------------------------'))
    gutil.log('')
})
